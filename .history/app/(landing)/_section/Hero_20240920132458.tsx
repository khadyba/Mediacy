    ...
    return (
      <div className="flex flex-col space-y-6 select-none items-center md:items-start text-center md:text-left max-w-full">
        <h1 className="font-bold text-[40px] leading-[50px] md:text-[60px] md:leading-[81px] max-w-full">
          Bienvenue sur <br />
          <span className="text-[#6841DA]">SnippetVault</span>
        </h1>
        <p className="font-light text-xs md:text-base max-w-full">
          Gérez et accédez facilement à vos extraits de code JavaScript préférés. <br />
          Créez, organisez et trouvez rapidement le code dont vous avez besoin pour optimiser votre processus de développement.
        </p>
