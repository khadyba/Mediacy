    ...
    return (
      <div className="flex flex-col space-y-6 select-none items-center md:items-start text-center md:text-left max-w-full">
        ...
        <p className="font-light text-xs md:text-base max-w-full">
          Gérez et accédez facilement à vos extraits de code JavaScript préférés. Créez, organisez et trouvez rapidement le code dont vous avez besoin pour optimiser votre processus de développement.
        </p>
