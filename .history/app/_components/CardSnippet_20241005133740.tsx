    ...
    <div className="flex flex-col items-center ">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 max-w-screen-xl mt-10">
        {snippets.slice(0, visibleCount).map((snippet) => (
          <Card key={snippet.id} className="w-full max-w-lg shadow-lg bg-purple-400 transition duration-200 hover:bg-white-200"> {/* Augmenter la largeur et ajouter box-shadow */}
            <CardHeader>
