...
const navigation = [
  {
    id: 1,
    item: "Accueil", // Correction de "Acceuil" à "Accueil"
    href: "/", // Page d'accueil
  },
  {
    id: 2,
    item: "Explorer les Snippets", // Traduction en français
    href: "/snippets", // Page pour explorer les snippets
  },
  {
    id: 3,
    item: "Collections", // Reste le même
    href: "/collections", // Page pour voir les collections de snippets
  },
  {
    id: 4,
    item: "Ma Bibliothèque", // Traduction en français
    href: "/library", // Page pour voir les snippets enregistrés ou favoris
  },
  {
    id: 5,
    item: "À Propos", // Traduction en français
    href: "/about", // Page à propos de l'application
  },
  {
    id: 6,
    item: "Contact", // Reste le même
