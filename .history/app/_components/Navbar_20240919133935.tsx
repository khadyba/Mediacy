...
const navigation = [
  ...
  export const Navbar = () => {
    ...
    const [language, setLanguage] = useState("en"); // Par défaut, en anglais
     ...
     const handleLanguageChange = (any) => {
      setLanguage(language);
    // Logique pour changer la langue de l'application
    // Cela peut inclure le redémarrage de l'application avec la nouvelle langue
  };
          ...
          <NavigationMenuList>
            <NavigationMenuItem>
              <div className="relative">
                <Button onClick={() => handleLanguageChange(language === "en" ? "fr" : "en")} variant="primary" size="lg">
